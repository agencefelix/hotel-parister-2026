 ...
 * `.claude/figma/integration/pages/<slug>.json`. Performs NO database write.
 *
...
final class FigmaParsePageCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('output-dir', null, InputOption::VALUE_REQUIRED, 'Dossier de sortie des JSON', $this->projectDir.'/.claude/figma/integration/pages')
            ->addOption('screenshot-dir', null, InputOption::VALUE_REQUIRED, 'Dossier des captures par bande', $this->projectDir.'/.claude/figma/integration/screenshots')
    ...
    private function captureScreenshots(SymfonyStyle $io, InputInterface $input, string $fileKey, string $nodeId, ParsedPage $page): void
    {
        ...
        try {
            ...
            $mediaDir = $this->projectDir.'/.claude/figma/integration/media/'.$page->slug;
