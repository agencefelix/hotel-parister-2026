 ...
 * `.claude/figma/integration/layout/*.json`. READ-ONLY — performs NO database write.
 *
...
final class FigmaCaptureLayoutCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('layout-dir', null, InputOption::VALUE_REQUIRED, 'Dossier des JSON de layout', $this->projectDir.'/.claude/figma/integration/layout')
            ->addOption('output-dir', null, InputOption::VALUE_REQUIRED, 'Dossier des captures', $this->projectDir.'/.claude/figma/integration/screenshots/layout');
    }
